...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, One_Wire_Pin|DS1302_CE_Pin|IPS_CS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(IPS_RES_GPIO_Port, IPS_RES_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : One_Wire_Pin DS1302_CE_Pin IPS_CS_Pin */
  GPIO_InitStruct.Pin = One_Wire_Pin|DS1302_CE_Pin|IPS_CS_Pin;
